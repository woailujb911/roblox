...
local Window = WindUI:CreateWindow({
    ...
    -- Background = "rbxassetid://100496422273191", -- rbxassetid only
})
...
Tabs.ParagraphTab:Paragraph({
    ...
    Desc = "Test Paragraph",
    Image = "https://i.postimg.cc/BZg1G1Wq/4k.jpg",
    ImageSize = 42, -- default 30
    Thumbnail = "https://i.postimg.cc/BZg1G1Wq/4k.jpg",
...
Tabs.NotificationTab:Button({
    ...
    Callback = function() 
        WindUI:Notify({
            ...
            Icon = "image",
            Duration = 5,
            Background = "rbxassetid://100496422273191"
        })
    end
})
